  ...
  return (
    <Card shadow className="p-6">
      <dl className="divide-y divide-line">
        <div className="py-4">
          <dt className="text-sm font-medium text-muted">旅程名稱</dt>
          <dd className="mt-1 text-base font-medium text-ink">{trip.title}</dd>
        </div>
        <div className="py-4">
          <dt className="text-sm font-medium text-muted">目的地</dt>
          <dd className="mt-1 text-base font-medium text-ink">{trip.destination}</dd>
        </div>
        <div className="py-4">
          <dt className="text-sm font-medium text-muted">日期</dt>
          <dd className="mt-1 text-base font-medium text-ink">
            {formatDate(trip.start_date)} – {formatDate(trip.end_date)}
          </dd>
        </div>
        <div className="py-4">
          <dt className="text-sm font-medium text-muted">描述</dt>
          <dd className="mt-1 text-base font-medium text-ink whitespace-pre-wrap leading-relaxed">
            {trip.description || '—'}
          </dd>
        </div>
      </dl>
...
function DeleteTripSection({ tripId, tripTitle }: DeleteTripSectionProps) {
  ...
  return (
    <>
      <div className="rounded-xl border-2 border-red-400 bg-surface p-6 shadow-sm">
    ...
    return (
      <div className="p-6 max-w-3xl">
        <div className="mb-8">
          ...
          <p className="text-sm text-muted mt-1">你可以查看這趟旅程的基本資訊。只有旅程擁有者可以修改設定。</p>
        </div>
